  ...
  return (
    ...
    >
      <g transform="translate(0 1)">
        <line x2="27.805" fill="none" stroke={color} strokeWidth="2" />
        <line
          x2="27.805"
...
export const CameraIcon = () => {
  return (
    <svg
      ...
      width="21.551"
      height="17.959"
      viewBox="0 0 21.551 17.959"
    >
      <g transform="translate(-4 -6)">
        <path
          d="M14.775,11.388a4.49,4.49,0,1,0,4.49,4.49A4.49,4.49,0,0,0,14.775,11.388Zm0,8.082a3.592,3.592,0,1,1,3.592-3.592A3.592,3.592,0,0,1,14.775,19.469Zm8.531-9.877H20.89L19.714,7.239A2.236,2.236,0,0,0,17.7,6H11.848A2.236,2.236,0,0,0,9.837,7.239L8.66,9.592H6.245A2.245,2.245,0,0,0,4,11.837v9.877a2.245,2.245,0,0,0,2.245,2.245H23.306a2.245,2.245,0,0,0,2.245-2.245V11.837A2.245,2.245,0,0,0,23.306,9.592Zm1.347,12.122a1.347,1.347,0,0,1-1.347,1.347H6.245A1.347,1.347,0,0,1,4.9,21.714V11.837A1.347,1.347,0,0,1,6.245,10.49H8.939a.458.458,0,0,0,.4-.251l1.293-2.6A1.347,1.347,0,0,1,11.848,6.9H17.7a1.347,1.347,0,0,1,1.212.745l1.293,2.6a.458.458,0,0,0,.4.251h2.694a1.347,1.347,0,0,1,1.347,1.347Z"
          fill={colors.GOLD}
        />
      </g>
    </svg>
